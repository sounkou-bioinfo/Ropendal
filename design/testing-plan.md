...
- `ropendal_store_open()`, `ropendal_store_read_aio()`, `ropendal_store_read_into_aio()`, `ropendal_store_write_aio()`, `ropendal_store_replace_aio()`, `ropendal_store_exists_aio()`, `ropendal_store_ls_aio()`, and `ropendal_store_delete_aio()` cover prefix-scoped native byte-store operations and caller-owned buffers
