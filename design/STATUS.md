...
6. Broaden native C API remote-service and cancellation-race coverage now that byte-store, byte, metadata, namespace, codec, CV, and monitor primitives are implemented.
