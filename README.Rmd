...
[`nanoarrow`](https://arrow.apache.org/nanoarrow/latest/r/) write an IPC stream,
store the raw payload, then read it back and materialize the table again.

```{r quick-start-arrow-ipc, eval = requireNamespace("nanoarrow", quietly = TRUE)}
